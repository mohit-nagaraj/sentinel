    ...
    const query = vi.fn().mockResolvedValue([
      {
        ...
        assessment_repository_host: "github.com",
        assessment_repository_owner: "sentinel",
        assessment_repository_name: "demo",
        assessment_pull_request_number: 29,
        assessment_base_sha: "1".repeat(40),
        assessment_head_sha: "2".repeat(40),
        assessment_report_available: true,
        started_at: now,
        finished_at: now,
      },
    ])
