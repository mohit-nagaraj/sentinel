...
| SNT-003 | [Supabase operational state, secrets, and artifact storage](./.tasks/milestone-01-foundation/SNT-003-supabase-operational-schema.md) | SNT-001, SNT-002 | review |
...
|---|---:|---:|---|
| M1 Foundation and durable execution | 2 | 6 | in-progress |
...
| **Overall** | **2** | **35** | **review: SNT-003** |

## Active front

- **SNT-003** — Supabase operational state, secrets, and artifact storage is awaiting review.
