...
| M2 Deterministic source evidence | 1 | 7 | review: SNT-008, SNT-009, SNT-010 |
...
| **Overall** | **7** | **35** | **review: SNT-008, SNT-009, SNT-010** |
...
- **SNT-010** — PHP and Laravel structural indexer is in review.
