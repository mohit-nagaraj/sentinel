...
- `app/assessments/[assessmentId]/page.tsx` - owner-scoped assessment report entry point.
- `components/assessment-report-workspace.tsx` - product-first report, evidence drill-down, and print presentation.
- `lib/assessment-report-service.ts` - private report, download, and evidence-excerpt delivery boundary.
