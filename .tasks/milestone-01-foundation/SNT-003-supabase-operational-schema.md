...
- Default verification on 2026-09-07: 12 files and 66 tests passed without provider variables.
- Opt-in disposable local verification: 3 files and 8 database/Storage/Vault tests passed; `supabase db lint --schema sentinel` reported no errors.
